...
<footer class="footer">
    <div class="footer__text"><strong><?php bloginfo('name') ?></strong> par <a class="link link--green" href="#">oClock Team</a>. La meilleure source pour se régaler.</div>
    <div class="logo logo--green">
        <i class="fa fa-cutlery"></i> <?php bloginfo('name') ?>2017
    </div>
</footer>
</div>
